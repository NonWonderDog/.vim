...
syntax keyword plantumlTypeKeyword namespace component package interface abstract class interface enum object participant activity skinparam 
syntax keyword plantumlKeyword state actor partition title legend page newpage activate as deactivate note left right top bottom of end
syntax keyword plantumlKeyword if then else endif
syntax keyword plantumlKeyword alt opt loop par break critical group
syntax keyword plantumlKeyword scale hide
syntax keyword plantumlTypeKeyword circle empty members fields attributes stereotype description footbox
...
syntax match plantumlHorizontalArrow /\%(<|\|<<\|<\|\*\|\<o\|\\\\\|\\\|\/\/\|\/\)\?[-\.]\%(le\?f\?t\?\|ri\?g\?h\?t\?\)\?[-\.]\%(|>\|>>\|>\|\*\|o\>\|\\\\\|\\\|\/\/\|\/\|\.\|-\)\?\%(\[[^\]]*\]\)\?/ contains=plantumlLabel
syntax match plantumlVerticalArrow /\%(<|\|<<\|<\|\*\|\<o\|\\\\\|\\\|\/\/\|\/\)\?[-\.]\%(up\?\|do\?w\?n\?\)\?[-\.]\%(|>\|>>\|>\|\*\|o\>\|\\\\\|\\\|\/\/\|\/\|\.\|-\)\?\%(\[[^\]]*\]\)\?/ contains=plantumlLabel
...
syntax match plantumlHorizontalArrow /\%(<|\|<<\|<\|\*\|\<o\|\\\\\|\\\|\/\/\|\/\)\?[-\.]\[hidden\]\%(|>\|>\|\*\|o\>\|\\\\\|\\\|\/\/\|\/\|\.\|-\)\?/
syntax match plantumlHorizontalArrow /\%(<|\|<\|\*\|\<o\|\\\\\|\\\|\/\/\|\/\)\?\[hidden\][\.-]\%(|>\|>\|\*\|o\>\|\\\\\|\\\|\/\/\|\/\|\.\|-\)\?/
syntax match plantumlVerticalArrow /\%(<|\|<<\|<\|\*\|\<o\|\\\\\|\\\|\/\/\|\/\)\?[-\.]\[hidden\][-\.]\%(|>\|>>\|>\|\*\|o\>\|\\\\\|\\\|\/\/\|\/\|\.\|-\)\?/

" Class or State
syntax region plantumlClass start=/\%(\<\%(class\|interface\|enum\|abstract\)\>.\{-}\)\@<={/ end=/\s*}/ transparent contains=plantumlClassArrows,
\                                                         plantumlKeyword,
\                                                         @plantumlClassOp
...
" Sterotypes
syntax match plantumlStereotype "<<\(node\|rect\|folder\|frame\|cloud\|database\|card\)>>"
